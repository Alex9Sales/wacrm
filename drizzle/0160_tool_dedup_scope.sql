...
--
-- Caso de um comprador (Família do Gás, 04/09): `criar_pedido` rodou 3× para UMA
...
-- modelo redigitou diferente ("Rua Exemplo, 123" × "Rua
-- Exmplo 123"). Comparar argumento nunca ia segurar isso.
--
