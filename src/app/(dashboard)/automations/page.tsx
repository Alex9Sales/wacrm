...
export default function AutomationsPage() {
  ...
  async function load() {
    try {
      ...
      if (!res.ok) {
        throw new Error(body?.error ?? "Falha ao carregar automações")
      }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Crie automações que reagem aos eventos do WhatsApp® automaticamente.
          </p>
        </div>
        <GatedButton
          canAct={canCreate}
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-foreground">{pendingDelete?.name}</span> e todo o histórico de
