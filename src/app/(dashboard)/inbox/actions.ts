...
export async function updateConversationAssignment(
  ...
  // Supervisor+ only ("distribuir atendimento"). Agents (incl. ones pulled in
  // via a private @mention) must not be able to (re)assign — the UI hides the
  // control, and this is the authoritative check behind it.
