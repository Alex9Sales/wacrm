...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova mensagem recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira vez que este contato te envia mensagem (também funciona para contatos adicionados manualmente)",
  },
    ...
    <div className="space-y-2">
      <div>
        ...
        <Input
          ...
          placeholder="ex.: preços, pedir demonstração, falar com vendas"
          className="bg-muted text-foreground"
        />
      </div>
      <div>
...
function previewFor(step: BuilderStep): string {
  switch (step.step_type) {
    ...
    case "send_webhook":
      return (step.step_config.url as string) || "nenhuma url"
    default:
      return ""
  }
}
