  ...
  useEffect(() => {
    async function fetchTemplates() {
      try {
        ...
        // would 400 at broadcast time. The action already filters to
        // APPROVED, newest-first, and scopes to the caller's account.
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Selecione um template aprovado para o seu disparo.
        </p>
      </div>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <h3 className="min-w-0 break-all text-sm font-medium text-foreground">
                    {template.name}
                  </h3>
                  <span
                ...
                <p className="line-clamp-3 break-words text-xs text-muted-foreground">{template.body_text}</p>
