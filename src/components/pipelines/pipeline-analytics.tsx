    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Contagem de todos os negócios deste funil que não estão marcados como Perdido. Negócios ganhos entram na conta."
        />
        <Metric
          icon={<DollarSign className="h-4 w-4 text-primary" />}
          label="Valor do funil"
          value={formatCurrency(stats.totalValue, defaultCurrency)}
          tooltip="Soma dos valores de todos os negócios deste funil, exceto os marcados como Perdido."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto × a probabilidade da etapa. Primeira etapa ≈ 10%, subindo até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
