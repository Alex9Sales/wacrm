        ...
        {result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Compartilhe este link com o novo membro. Ele poderá se cadastrar (ou entrar) e acessar a conta como{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Não guardamos o link em texto — ao fechar esta janela ele some. Para reenviar, revogue este convite e crie um novo.
              </div>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Gere um link de convite único. Compartilhe pelo WhatsApp, Slack ou onde preferir — sem precisar de e-mail.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground">
                  Etiqueta{' '}<span className="text-xs text-muted-foreground">(opcional)</span>
                </Label>
                <Input
