...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    if (!phoneNumberId.trim()) {
      toast.error('O ID do número é obrigatório');
      return;
    }
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Insira novamente o Token de acesso para salvar as alterações');
        setSaving(false);
        return;
      }
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {config && !tokenEdited && (
                <p className="text-xs text-muted-foreground">
                  O token fica oculto por segurança. Insira-o novamente para atualizar a configuração.
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <strong className="text-muted-foreground">recebidas</strong> de um número de{' '}
                ...
                caso contrário, a Meta encaminha os eventos recebidos para o
                último app que reivindicou o número (o sintoma que afeta os
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Copie seu <strong className="text-foreground">ID do número</strong></li>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Cole a <strong className="text-foreground">URL de callback do webhook</strong> mostrada acima</li>
