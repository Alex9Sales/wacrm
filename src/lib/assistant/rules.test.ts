...
describe('assistente do dono — textos', () => {
  ...
  it('agenda e equipe', () => {
    ...
    const e = formatTeam({ members: [{ name: 'Vitor', openConversations: 3, sentToday: 12 }], unassignedAnswered: 2, waiting: [] })
    expect(e).toContain('Vitor — 12 conversas atendidas · 3 abertas')
    expect(e).toContain('Sem responsável — 2 conversas atendidas')
