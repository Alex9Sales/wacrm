...
export const wahaProvider: WhatsAppProvider = {
  ...
  parseWebhook(body: unknown): ParsedWebhook {
    ...
    if (event === 'message' || event === 'message.any') {
      ...
      // (18/09: saíram os 2 logs TEMP da prova de conceito de comentário de
      // comunidade — gravavam a chave de decifrar de um grupo real e o conteúdo
      // cifrado dos comentários no log. Eram só console.log: nada dependia deles.)
      if (
        !text &&
        !media &&
        !viewOnce &&
